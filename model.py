...
#  the SCALED DOWN first CNN branch (CNN1_small)
class CNN1_small(nn.Module):
    def __init__(self):
        super(CNN1_small, self).__init__()
        # Reduced Convolutional layers from paper
...
# the SCALED DOWN second CNN branch (CNN2_small)
...
class CombinedCNN_small(nn.Module):
    def __init__(self, num_classes=4): # 4 for each of the alzheimer classes
